...
use serv_runtime::{
	constants::currency::*, opaque::SessionKeys, AccountId, AuthorityDiscoveryConfig, Balance,
	BalancesConfig, CouncilConfig, GenesisConfig, GrandpaConfig, ImOnlineConfig, MaxNominations,
...
fn testnet_genesis(
	...
	GenesisConfig {
		...
		babe: serv_runtime::BabeConfig {
			authorities: vec![],
			epoch_config: Some(serv_runtime::BABE_GENESIS_EPOCH_CONFIG),
		},
